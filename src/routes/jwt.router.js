...
import { sendUserInfo } from '../utils.js';  // Agrega la importación de sendUserInfo
...
jwtEstrategy.get("/current", authToken, sendUserInfo, (req, res) => {
  res.send({ status: "success", payload: res.locals.userInfo });
});
